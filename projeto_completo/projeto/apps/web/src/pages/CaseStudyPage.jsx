...
const CaseStudyPage = () => {
  ...
  if (!caseStudy) {
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center">
        <Helmet>
          <title>Case Study Not Found - Capuk</title>
        </Helmet>
  ...
  return (
    <>
      <Helmet>
        <title>{`${caseStudy.title} - Case Study | Capuk`}</title>
          ...
          <article className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="editorial-frame">
                <img 
                  src={caseStudy.image} 
                  alt={`${caseStudy.title} traditional marketing campaign`} 
            ...
            >
              ...
              <Link 
                to="/#booking" 
                className="inline-flex items-center justify-center px-10 py-6 bg-primary text-primary-foreground font-bold uppercase tracking-widest text-sm hover:bg-primary/90 transition-all active:scale-[0.98] shadow-editorial"
              >
