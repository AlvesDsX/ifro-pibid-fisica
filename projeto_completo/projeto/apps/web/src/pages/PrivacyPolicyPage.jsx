...
const PrivacyPolicyPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Privacy Policy | Capuk</title>
        <meta name="description" content="Capuk's comprehensive privacy policy outlining our data collection, usage, and security practices." />
      </Helmet>
      ...
      <div className="min-h-screen bg-background text-foreground selection:bg-primary selection:text-primary-foreground">
        ...
        <main className="pt-32 pb-24 md:pt-48 md:pb-32">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6">Privacy Policy</h1>
              <p className="text-xl text-muted-foreground">Last Updated: April 16, 2026</p>
            </motion.div>
              ...
              >
                <section id="introduction" className="scroll-mt-32">
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    <p>
                      At Capuk Marketing Agency ("Capuk", "we", "us", or "our"), we respect your privacy and are committed to protecting your personal data. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or engage with our marketing services.
                    </p>
                    <p>
                ...
                <section id="data-collection" className="scroll-mt-32">
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    ...
                    <ul className="list-disc pl-5 space-y-2 mt-4 text-foreground/80">
                      <li><strong className="text-foreground">Personal Data:</strong> Personally identifiable information, such as your name, email address, telephone number, company name, and job title that you voluntarily give to us when registering for services, submitting inquiries, or scheduling consultations.</li>
                      <li><strong className="text-foreground">Derivative Data:</strong> Information our servers automatically collect when you access our website, such as your IP address, browser type, operating system, access times, and the pages you have viewed.</li>
                      <li><strong className="text-foreground">Financial Data:</strong> Data related to your payment method that we may collect when you purchase our services. All financial data is stored by our payment processors.</li>
                    </ul>
                  </div>
                </section>
                ...
                <section id="data-usage" className="scroll-mt-32">
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    ...
                    <ul className="list-disc pl-5 space-y-2 mt-4 text-foreground/80">
                      ...
                      <li>Generate insights and analytics to improve our marketing strategies.</li>
                      <li>Process payments and refunds.</li>
                      <li>Send you targeted marketing communications (subject to your consent).</li>
                ...
                <section id="cookies-tracking" className="scroll-mt-32">
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    <p>
                      We may use cookies, web beacons, tracking pixels, and other tracking technologies on our site to help customize our services and improve your experience.
                    </p>
                    <p>
                ...
                <section id="contact" className="scroll-mt-32">
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    ...
                    <div className="bg-muted/30 p-8 mt-6 border border-border">
                      <p className="font-bold text-foreground mb-4">Capuk Marketing Agency</p>
                      <p>Email: <a href="mailto:privacy@capuk.com" className="text-foreground hover:underline">privacy@capuk.com</a></p>
        ...
        <AnimatePresence>
          {showBackToTop && (
            <motion.button
              ...
              onClick={scrollToTop}
              className="fixed bottom-8 right-8 p-4 bg-primary text-primary-foreground shadow-lg hover:bg-primary/90 transition-colors z-50 group"
